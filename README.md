...
```
npm i --save @arneson/react-native-rich-text-editor
```
...
`@arneson/react-native-rich-text-editor` exports two Components and one const dictionary:
